...
The resulting trainable parameter counts for the BRCA joined-training models are reported in Table~\ref{tab:params}.
...
The baseline families and their roles in the study design are summarized in Table~\ref{tab:baseline_families}.
